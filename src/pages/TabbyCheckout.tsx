      ...
      <div className="max-w-[480px] mx-auto bg-white min-h-screen">
        ...
        <div className="px-8">
          ...
          <div className="flex items-center gap-3 mb-6">
            ...
            <div className="flex-1">
              <input
                ...
                className="w-full border border-gray-300 rounded-lg px-4 py-3 text-right outline-none focus:border-[#3CDBC0] focus:ring-1 focus:ring-[#3CDBC0] transition-all text-base"
                dir="ltr"
              />
            </div>
          </div>
          ...
          <button
            ...
            className="w-full bg-[#3CDBC0] hover:bg-[#2fc4aa] disabled:bg-gray-200 disabled:text-gray-400 text-white font-semibold py-3.5 rounded-lg transition-all text-base"
          >
            استمرار
          </button>
